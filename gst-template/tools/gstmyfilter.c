...
static GstFlowReturn gst_myfilter_transform_frame (GstVideoFilter * filter,
    GstVideoFrame * inframe, GstVideoFrame * outframe);
static GstFlowReturn gst_myfilter_transform_frame_ip (GstVideoFilter * filter,
    GstVideoFrame * frame);
...
gst_myfilter_set_info (GstVideoFilter * filter, GstCaps * incaps,
    GstVideoInfo * in_info, GstCaps * outcaps, GstVideoInfo * out_info)
{
  GstMyfilter *myfilter = GST_MYFILTER (filter);

  GST_DEBUG_OBJECT (myfilter, "set_info");
    ...
    GstVideoFrame * outframe)
{
  ...
  GST_DEBUG_OBJECT (myfilter, "transform_frame");
...
gst_myfilter_transform_frame_ip (GstVideoFilter * filter, GstVideoFrame * frame)
{
  ...
  GST_DEBUG_OBJECT (myfilter, "transform_frame_ip");
